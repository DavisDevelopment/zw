...
import chrome.messaging.BGServer in Server;
...
/* === Instance Fields === */
	...
	private var tab : Maybe<Tab>;

	/* (server) The MessagePool [this] is attached to */
	private var pool : Null<Server>;
